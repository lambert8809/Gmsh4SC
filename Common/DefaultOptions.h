...
StringXString GeneralOptions_String[] = {
  ...
  { F|O, "GraphicsFontEngine" , opt_general_graphics_font_engine , "Cairo" ,
...
StringXNumber MeshOptions_Number[] = {
  ...
  { F|O, "Points" , opt_mesh_points , 1. ,      //Prof. Yu, change default visibility for nodes
  ...
  { F|O, "SurfaceFaces" , opt_mesh_surfaces_faces , 1. ,  // Prof. Yu, show Surfacefaces after generating mesh
...
StringXNumber ViewOptions_Number[] = {
  ...
  { F|O, "ShowElement" , opt_view_show_element , 1. ,  // Prof. Yu, show element boundary in post-processing
