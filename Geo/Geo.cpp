...
{
  if(CTX::instance()->geom.oldNewreg)
    //return NEWREG();                                                     //... Prof. Wenbin Yu
	//return (GModel::current()->getGEOInternals()->MaxPhysicalNum + 1);     //... Prof. Wenbin Yu  early version
    return (GModel::current()->getGEOInternals()->MaxPhysicalNum + 1);       //... Prof. Wenbin Yu
  else
