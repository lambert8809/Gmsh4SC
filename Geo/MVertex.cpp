...
//Prof. Wenbin Yu
    ...
    if( x()<0.0000000001 && x()> -0.0000000001) x()=0;      //to remove extremely small number e.g. 2.7522429e-012 or negative
	if( y()<0.0000000001 && y()> -0.0000000001) y()=0;
	if( z()<0.0000000001 && z()> -0.0000000001) z()=0;
