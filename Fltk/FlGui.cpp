...
FlGui::FlGui(int argc, char **argv)
{
  ...
  //Prof. Yu
  geoContext1 = new geometryContextWindow1(CTX::instance()->deltaFontSize);
  geoContext7 = new geometryContextWindow7(CTX::instance()->deltaFontSize);   // Prof. Yu
  geoContext7_1 = new geometryContextWindow7_1(CTX::instance()->deltaFontSize);
  geoContext2 = new geometryContextWindow2(CTX::instance()->deltaFontSize);
  geoContext8 = new geometryContextWindow8(CTX::instance()->deltaFontSize);   // Prof. Yu
  geoContext9 = new geometryContextWindow9(CTX::instance()->deltaFontSize);   // Prof. Yu
  geoContext10 = new geometryContextWindow10(CTX::instance()->deltaFontSize);   // Prof. Yu
  geoContext5 = new geometryContextWindow5(CTX::instance()->deltaFontSize);
  geoContext11 = new geometryContextWindow11(CTX::instance()->deltaFontSize);   // Prof. Yu
  geoContext12 = new geometryContextWindow12(CTX::instance()->deltaFontSize);   // Prof. Yu
  geoContext13 = new geometryContextWindow13(CTX::instance()->deltaFontSize);   // Prof. Yu
  geoContext13_1 = new geometryContextWindow13_1(CTX::instance()->deltaFontSize);   // Prof. Yu
  geoContext13_2 = new geometryContextWindow13_2(CTX::instance()->deltaFontSize);   // Prof. Yu
  geoContext13_3 = new geometryContextWindow13_3(CTX::instance()->deltaFontSize);   // Prof. Yu
  geoContext13_4 = new geometryContextWindow13_4(CTX::instance()->deltaFontSize);   // Prof. Yu
  geoContext13_5 = new geometryContextWindow13_5(CTX::instance()->deltaFontSize);   // Prof. Yu
  geoContext13_6 = new geometryContextWindow13_6(CTX::instance()->deltaFontSize);   // Prof. Yu
  geoContext13_7 = new geometryContextWindow13_7(CTX::instance()->deltaFontSize);   // Prof. Yu
  geoContext13_8 = new geometryContextWindow13_8(CTX::instance()->deltaFontSize);   // Prof. Yu
  geoContext13_9 = new geometryContextWindow13_9(CTX::instance()->deltaFontSize);   // Prof. Yu
  geoContext14 = new geometryContextWindow14(CTX::instance()->deltaFontSize);   // Prof. Yu
  geoContext14P = new geometryContextWindow14P(CTX::instance()->deltaFontSize);   // Prof. Yu
  geoContext14_1 = new geometryContextWindow14_1(CTX::instance()->deltaFontSize);   // Prof. Yu

  geoContext20 = new geometryContextWindow20(CTX::instance()->deltaFontSize);   // Prof. Yu
  geoContext21 = new geometryContextWindow21(CTX::instance()->deltaFontSize);   // Prof. Yu
...
void FlGui::setGraphicTitle(std::string title)
{
  for(unsigned int i = 0; i < graph.size(); i++){
    ...
    std::string tilname = GModel::current()->getFileName();
	for (size_t i = tilname.size(); i > 0; i--) {
			if (tilname[i] == '/') {
				tilname = tilname.erase(0, i+1);
				break;
			}
		}
		title = tilname;
    if(!i)
      sstream << "SwiftComp - " << title;
    else
      sstream << "SwiftComp - " << title << " [" << i << "]";
